...
class ADMINDrawerUserController extends StatefulWidget {
  ...
  @override
  _ADMINDrawerUserControllerState createState() => _ADMINDrawerUserControllerState();
}

class _ADMINDrawerUserControllerState extends State<ADMINDrawerUserController>
                        ...
                        child: SizedBox(
                          ...
                          child: AdminHomeDrawer(
                            screenIndex: widget.screenIndex == null
                                ? DrawerIndex.HOME : widget.screenIndex,
                            iconAnimationController: iconAnimationController,
                            callBackIndex: (DrawerIndex indexType) {
                               // print('Side Bar Type is clicked');
                              onDrawerClick();
                              try {
                                //print('Inside try and catch');
